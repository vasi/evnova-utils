...
@cmds = (
	...
	shieldre	=> [\&shieldRegen, 'RSRC SHIP...',
		'show old EV shield regen values',
	...
	avail		=> [\&availMisns, '[-vufrli] PILOT [PROGRESS]',
		...
		'Flag --record filters missions that need better legal record',
